...
class AJProgressView: UIView {
    ...
    public var imgLogo: UIImage = UIImage(named:"ProjectIcon")!
    ...
    private func setupAJProgressView() {
        ...
        let radius = (min(innerView.bounds.size.width, innerView.bounds.size.height)/2.0 - self.shapeLayer.lineWidth / 2.0) - 15
        print(radius)
        ...
        imgViewLogo.frame = CGRect(x: 0, y: 0, width: widthProgressView * 0.7, height: widthProgressView * 0.7)
